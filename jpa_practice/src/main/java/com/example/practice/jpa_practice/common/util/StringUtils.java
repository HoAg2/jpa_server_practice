...
public class StringUtils {
    ...
    /**
     * 문자열이 표현식에 일치하는 그룹을 가져옴
     *
     * @param str   문자열
     * @param regex 표현식
     * @return
     */
    public static String matchesGet(String str, String regex, int index) {
    ...
    /**
     * 문자열이 표현식에 일치하는 배열을 가져옴
     *
     * @param str   문자열
     * @param regex 표현식
     * @return
     */
    public static String[] matchesArray(String str, String regex) {
        if (isEmpty(str)) return null;
    ...
    public static String randomNnumeric(int count) {
    ...
    public static boolean startWidth(String str, String s) {
        if (StringUtils.isAnyEmpty(str, s)) return false;
    ...
    public static String makeQueryString(String urlString, Object o, Class<?> clazz) {
        ...
        try {
            for (Field f : clazz.getDeclaredFields()) {
                ...
                queryString.append(f.getName()).append("=").append(URLEncoder.encode(String.valueOf(f.get(o)), Charset.defaultCharset())).append("&");
            }
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        return urlString + queryString.toString();
    }
}
